...
import { TIME_SLOTS } from "@/contants";
...
function InterviewScheduleUI() {
     ...
     useEffect(() => {
          ...
          setFormData((prev) => {
               if (prev.interviewerIds.length) return prev;
               return { ...prev, interviewerIds: [currentUser._id] };
          });
     }, [user?.id, users]);
     ...
     const addInterviewer = (interviewerId: Id<"users">) => {
     ...
     const removeInterviewer = (interviewerId: Id<"users">) => {
          setFormData((prev) => ({
               ...prev,
     ...
     const selectedInterviewers = interviewers.filter((i) =>
          formData.interviewerIds.includes(i._id)
     );

     const availableInterviewers = interviewers.filter(
          (i) => !formData.interviewerIds.includes(i._id)
     );
                              ...
                              <div className="space-y-4 py-4">
                                   ...
                                   <div className="space-y-2">
                                        ...
                                        <Select
                                             ...
                                             onValueChange={(candidateId) =>
                                                  setFormData({ ...formData, candidateId: candidateId as Id<"users"> })
                                             }
                                        >
                                             <SelectTrigger>
                                   ...
                                   <div className="space-y-2">
                                             ...
                                             {selectedInterviewers.map((interviewer) => (
                                                  ...
                                                  >
                                                       ...
                                                       {interviewer.clerkId !== user?.id && (
                                                            <button
                                                                 onClick={() => removeInterviewer(interviewer._id)}
                                        ...
                                        {availableInterviewers.length > 0 && (
                                             <Select onValueChange={(value) => addInterviewer(value as Id<"users">)}>
                                                  <SelectTrigger>
